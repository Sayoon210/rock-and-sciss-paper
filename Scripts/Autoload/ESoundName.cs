...
/// AudioManager loads Assets/Audio/{member} and finds the extension itself — so renaming a
/// member renames a file. The source file's own name is not kept; ATTRIBUTIONS.md records
