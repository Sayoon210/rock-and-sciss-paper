...
/// GameLogic knows only ECardName; this is what a ECardName looks like on screen.
/// One .tres file per ECardName, loaded and indexed by CardDatabase. Card art has no
/// assets yet, so CardArt is left unset until some are added.</summary>
public partial class CardData : Resource
{
    [Export]
    public ECardName CardName { get; set; }
